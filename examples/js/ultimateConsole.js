...
let currentVisualizer = new QuantumHolographicVisualizer(canvasId, 'content', 1.0, 0);
...
document.querySelectorAll('.system-btn').forEach(btn => {
    btn.addEventListener('click', () => {
        ...
        if (system === 'quantum') currentVisualizer = new QuantumHolographicVisualizer(canvasId, 'content', 1.0, 0);
        else if (system === 'faceted') currentVisualizer = new IntegratedHolographicVisualizer(canvasId, 'content', 1.0, 0);
        else currentVisualizer = new HolographicVisualizer(canvasId, 'content', 1.0, 0);
