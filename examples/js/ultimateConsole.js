...
function render() {
    ...
    const speed = Math.min(2.0, baseParams.speed + (bass + rms) * 0.45 * reactivity.amount);
    ...
    if (reactivity.enabled.color) {
        ...
        const saturation = Math.min(1.2, baseParams.saturation + mid * 0.35 * reactivity.amount);
