 ...
 * @property {{ parallaxDepth: number, gridShift: number, shimmer: number }} atmosphere
...
const CONTROL_KEYS = ['density', 'morph', 'color', 'chaos', 'rotation', 'camera', 'atmosphere'];
...
export class BehaviorSweepEngine {
    ...
    applyBehavioralReactivity(input = {}) {
        ...
        return {
            ...
            atmosphere: { parallaxDepth, gridShift, shimmer },
