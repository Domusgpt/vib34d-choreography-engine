    ...
    async createVisualizer() {
        ...
        this.controlBus.defineChannels({
            ...
            frameBlend: {
                ...
                smoothing: 0.8,
                audioMap: [
                    { path: 'rhythmPhases.accentPulse', scale: 0.3 },
                    { path: 'extremeDynamics.motionVelocity', scale: 0.28 }
                ],
                tags: ['lighting']
            },
            lightWrap: {
                ...
                smoothing: 0.84,
                audioMap: [
                    { path: 'bands.mid', scale: 0.25 },
                    { path: 'colorChoreography.accentLuma', scale: 0.2 }
                ],
                tags: ['lighting']
            },
            colorBleed: {
                ...
                smoothing: 0.86,
                audioMap: [
                    { path: 'colorChoreography.orbit', scale: 0.22 },
                    { path: 'extremeDynamics.chaosSurge', scale: 0.28 }
                ],
                tags: ['lighting', 'color']
            }
        });
