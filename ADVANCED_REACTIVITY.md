...
- **Mobile Alias** – `examples/mobile-smart.html` now redirects to the unified console with the mobile layout preset, keeping old bookmarks alive while steering everyone to the new UI.
