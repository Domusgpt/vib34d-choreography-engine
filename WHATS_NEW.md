...
### 📱 Mobile Smart now redirects to the unified deck
- [`examples/mobile-smart.html`](examples/mobile-smart.html) remains for legacy bookmarks but now performs a zero-delay redirect to the unified console with the mobile layout preset engaged.
