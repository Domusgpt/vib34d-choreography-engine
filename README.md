...
On GitHub Pages you can jump straight to the demo catalog at
`https://<your-org-or-user>.github.io/<your-repo-name>/examples/` (a lightweight
redirect keeps the uppercase `INDEX.html` entry working when you browse the
...
## ✅ Current capabilities & best-functionality checklist

For a concise rundown of what the stack supports today (baseline-first parameters, behavior-aware visualizers, single-canvas lifecycle, preview harness, and Pages-ready builds) plus the requirements to keep it stable, see [docs/CAPABILITIES.md](docs/CAPABILITIES.md).
...
- Demo catalog shortcut (works on Pages with the repo-derived base path):
  `https://<your-org-or-user>.github.io/<your-repo-name>/examples/`.
