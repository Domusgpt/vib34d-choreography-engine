...
- ✅ Capture helper now ignores expected headless WebGL console noise (software fallback and GPU ReadPixels stalls) so `--fail-on-console` only trips on actionable errors
