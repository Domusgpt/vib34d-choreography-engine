...
- If your environment blocks the dev server or you want parity with deployment assets, run `VISUAL_SMOKE_MODE=preview npm run visual:smoke`; this builds first, then serves via `vite preview` on the same strict port with longer readiness timeouts.
